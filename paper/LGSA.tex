...
% TODO: reward table; schedule + temperature-range table; Metropolis 2x2
% table (train x test); sampling-vs-greedy comparison; init cross-table
% (train init x test init).
%   sweeps: V5_reward, V6_sched, X4_temp_range, V7_metro (+ --no-metro eval),
%           V8_init_single / V8_init_multi (+ --INIT <type> eval)
